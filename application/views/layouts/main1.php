  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3">VMSS</div>
      </a>
      ...
      <li class="nav-item">
        <a class="nav-link" href="resolvedincident.html">
      ...
      <li class="nav-item">
        <a class="nav-link" href="falsealert.html">
              ...
              <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-primary text-uppercase mb-1"> Number of live locaions</div>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; Automated Land Encroachment Prevention System, Vadodara 2020</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
